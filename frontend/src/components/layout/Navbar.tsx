...
export function Navbar({ onOpenMobileMenu }: ModernNavbarProps) {
  ...
  const getBreadcrumbs = () => {
    ...
    if (path === '/handover-documents/new') {
      return [
        {
          label: 'Dokumen Serah Terima',
          href: '/handover-documents',
    ...
    if (
      path.startsWith('/handover-documents/') &&
      path.endsWith('/edit')
    ) {
      return [
        {
    ...
    // Handover document detail
    if (path.startsWith('/handover-documents/')) {
      return [
        {
          label: 'Dokumen Serah Terima',
          href: '/handover-documents',
              ...
              >
                ...
                {breadcrumbs.map((crumb, idx) => (
                  ...
                  >
                    <ChevronRight
                      size={13}
                      className="text-zinc-300 mx-1.5 shrink-0"
                    />
          ...
          >
            ...
            <div className="p-3.5 border-b border-zinc-100 flex items-center gap-3 bg-zinc-50/50">
              ...
              <input
                ...
                placeholder="Cari dokumen, nomor invoice, klien, atau produk..."
            ...
            <div className="p-2.5 bg-zinc-50 border-t border-zinc-100 text-[10px] text-zinc-400 flex items-center justify-between px-3">
              <span>
                Tekan{' '}
                <kbd className="font-mono bg-white border border-zinc-200 px-1 py-0.5 rounded text-zinc-600 font-semibold">
                  ESC
                </kbd>{' '}
                untuk menutup
              </span>
