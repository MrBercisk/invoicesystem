    ...
    <div className="relative overflow-hidden bg-white border border-zinc-200 p-8 sm:p-12 text-zinc-900 max-w-[210mm] mx-auto">
      {status === 'draft' && (
        <div className="absolute inset-0 z-20 flex items-center justify-center pointer-events-none select-none">
          <span
            className="font-extrabold uppercase text-zinc-300"
      ...
      {status === 'paid' && (
        <div className="absolute inset-0 z-20 flex items-center justify-center pointer-events-none select-none">
          <div
            className="border-[6px] border-emerald-600 text-emerald-600 font-extrabold uppercase px-8 py-3 rounded-md"
            style={{ fontSize: '44px', letterSpacing: '8px', transform: 'rotate(-14deg)', opacity: 0.55 }}
          >
            Lunas
          </div>
        </div>
      ...
      {status === 'cancelled' && (
        <div className="absolute inset-0 z-20 flex items-center justify-center pointer-events-none select-none">
          <div
            className="border-[6px] border-red-600 text-red-600 font-extrabold uppercase px-6 py-3 rounded-md"
            style={{ fontSize: '38px', letterSpacing: '6px', transform: 'rotate(-14deg)', opacity: 0.55 }}
          >
            Dibatalkan
          </div>
        </div>
        ...
        <div>
          {invoice.company.logo && (
            <img
              ...
              className="max-h-10 max-w-[180px] object-contain mb-3"
            />
          )}
