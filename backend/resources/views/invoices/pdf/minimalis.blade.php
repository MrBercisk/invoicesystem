<div class="wrap">
    ...
    <div class="header">
        ...
        <div class="header-right">
            ...
            <div class="invoice-meta">
                <div><span class="muted">Tanggal </span>{{ $invoice->invoice_date->translatedFormat('d F Y') }}</div>
    ...
    <table class="totals-wrap"><tr><td></td><td class="totals-box">
        <table class="totals-inner">
            ...
            @endif
            <tr class="totals-final"><td>Total tagihan</td><td class="text-right mono">{{ 'Rp ' . number_format($invoice->total, 0, ',', '.') }}</td></tr>
        </table>
    </td></tr></table>
